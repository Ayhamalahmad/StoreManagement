...
class UpdatePerfumeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'code' => ['required', 'string', 'max:50', Rule::unique('perfumes', 'code')->ignore($perfume)],
            ...
            'gender.en' => 'required|string|max:50',
            'gender.tr' => 'required|string|max:50',
            'gender.ar' => 'required|string|max:50',
            ...
            'season.en' => 'nullable|string|max:50',
            'season.tr' => 'nullable|string|max:50',
            'season.ar' => 'nullable|string|max:50',
